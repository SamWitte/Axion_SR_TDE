...
function find_im_part(mu, M, a, n, l, m; debug=false, Ntot_force=5000, iter=500, xtol=1e-50, ftol=1e-90, return_both=false, for_s_rates=true, QNM=false, QNM_E=1.0, erg_Guess=nothing, max_n_qnm=10)
